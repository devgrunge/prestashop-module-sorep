 ...
 */
class Sorep_OverlayMenuShowMenuModuleFrontController extends ModuleFrontController
{ 
    ...
    {
   $this->setTemplate('module:sorep_overlaymenu/views/templates/hook/overlaymenu.tpl');
      parent::initContent();
      $this->context->smarty->assign(array());
      if (Tools::getValue('id') != '')
     $this->setTemplate('overlaymenu.tpl');
     else
    ...
    // $this->setTemplate('sorep_overlaymenu/slider');
  ...
  public function setMedia() {
    $this->registerStylesheet(
      'sorep_overlaymenu-default',
      'modules/sorep_overlaymenu/views/css/sorep_overlaymenu.css',
      array('media' => 'all', 'priority' => 150)
  );
  $this->context->controller->registerJavascript(
      'sorep_overlaymenu-default',
      'modules/sorep_overlaymenu/views/js/default.js',
 ...
 //set template
  ...
  //public function Link::getModuleLink($sorep_overlaymenu, $showSlider, array $params = array());
